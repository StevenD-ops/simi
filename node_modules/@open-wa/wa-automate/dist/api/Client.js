...
const optional_require_1 = __importDefault(require("optional-require"));
...
/** @ignore */
const pkg = fs_extra_1.readJsonSync(path.join(__dirname, '../../package.json')), optionalRequire = optional_require_1.default(require), isDataURL = (s) => !!s.match(/^data:((?:\w+\/(?:(?!;).)+)?)((?:;[\w\W]*?[^;])*),(.+)$/g), isBase64 = (str) => {
...
function convertMp4BufferToWebpDataUrl(file, processOptions = media_1.defaultProcessOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { default: _stream } = yield Promise.resolve().then(() => __importStar(require("stream")));
        ...
        const d = yield datauri_1.default(tempFile);
...
class Client {
        ...
        this.middleware = (useSessionIdInPath = false) => (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (req.method === 'POST') {
                ...
                if (args && !Array.isArray(args))
                    args = parse_function_1.default().parse(this[m]).args.map(argName => args[argName]);
                else if (!args)
                    args = [];
                if (this[m]) {
                    try {
    ...
    loaded() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_d = this._createConfig) === null || _d === void 0 ? void 0 : _d.deleteSessionDataOnLogout) || ((_e = this._createConfig) === null || _e === void 0 ? void 0 : _e.killClientOnLogout)) {
                this.onLogout(() => {
                    var _a, _b;
    ...
    preprocessMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this._createConfig.messagePreprocessor && preProcessors_1.MessagePreprocessors[this._createConfig.messagePreprocessor]) {
                return yield preProcessors_1.MessagePreprocessors[this._createConfig.messagePreprocessor](message, this);
            }
            return message;
        });
    }
    ...
    */
    ...
    stickerServerRequest(func, a = {}, fallback = false) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (a.file || a.image) {
                ...
                if (!isDataURL(a[key]) && !is_url_1.default(a[key]) && !isBase64(a[key])) {
                ...
                try {
                    ...
                    console.error((_a = err === null || err === void 0 ? void 0 : err.response) === null || _a === void 0 ? void 0 : _a.status, (_b = err === null || err === void 0 ? void 0 : err.response) === null || _b === void 0 ? void 0 : _b.data);
                    throw err;
                    return false;
                }
            }
    ...
    createMessageCollector(c, filter, options) {
        ...
        return new MessageCollector_1.MessageCollector(this.getSessionId(), this.getInstanceId(), chatId, filter, options);
    }
}
