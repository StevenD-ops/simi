...
export declare class SocketClient {
     ...
     */
    static connect(url: string, apiKey?: string): Promise<SocketClient & Client>;
    constructor(url: string, apiKey?: string);
    ask<M extends ClientMethods, P extends Parameters<Pick<Client, M>[M]>>(method: M, args?: P | {
        [k: string]: unknown;
    }): Promise<unknown>;
    listen(listener: SimpleListener, callback: (data: unknown) => void): Promise<boolean>;
}
