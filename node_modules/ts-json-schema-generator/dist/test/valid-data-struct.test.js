...
describe("valid-data-struct", () => {
    ...
    it("object-function-expression", utils_1.assertValidSchema("object-function-expression", "MyType"));
    ...
    it("interface-computed-property-name", utils_1.assertValidSchema("interface-computed-property-name", "MyObject"));
