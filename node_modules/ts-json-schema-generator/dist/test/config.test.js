...
exports.ExampleNullParser = exports.ExampleConstructorParser = exports.ExampleEnumTypeFormatter = exports.ExampleFunctionTypeFormatter = void 0;
...
function assertSchema(name, userConfig, tsconfig, formatterAugmentor, parserAugmentor) {
    return () => {
        ...
        const generator = new SchemaGenerator_1.SchemaGenerator(program, parser_1.createParser(program, config, parserAugmentor), formatter_1.createFormatter(config, formatterAugmentor), config);
