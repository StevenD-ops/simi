...
describe("valid-data-type", () => {
    ...
    it("type-aliases-primitive-with-id", utils_1.assertValidSchema("type-aliases-primitive-with-id", "MyString", "none", undefined, "testId"));
    ...
    it("type-date-annotation", utils_1.assertValidSchema("type-date-annotation", "MyObject", "basic"));
    ...
    it("type-intersection-union-enum", utils_1.assertValidSchema("type-intersection-union-enum", "MyObject"));
    ...
    it("type-extends-never", utils_1.assertValidSchema("type-extends-never", "MyType"));
    ...
    it("type-mapped-symbol", utils_1.assertValidSchema("type-mapped-symbol", "MyObject"));
    it("type-mapped-annotated-string", utils_1.assertValidSchema("type-mapped-annotated-string", "ExchangeRate", "extended"));
    ...
    it("type-recursive-deep-exclude", utils_1.assertValidSchema("type-recursive-deep-exclude", "MyType"));
});
