...
describe("valid-data-other", () => {
    ...
    it("function-parameters-default-value", utils_1.assertValidSchema("function-parameters-default-value", "Parameters<typeof myFunction>"));
    it("function-parameters-jsdoc", utils_1.assertValidSchema("function-parameters-jsdoc", "Parameters<typeof myFunction>", "basic"));
    it("function-parameters-optional", utils_1.assertValidSchema("function-parameters-optional", "Parameters<typeof myFunction>"));
    it("function-parameters-required", utils_1.assertValidSchema("function-parameters-required", "Parameters<typeof myFunction>"));
    ...
    it("array-min-items-1", utils_1.assertValidSchema("array-min-items-1", "MyType"));
    it("array-min-items-2", utils_1.assertValidSchema("array-min-items-2", "MyType"));
    it("array-min-max-items", utils_1.assertValidSchema("array-min-max-items", "MyType"));
    it("array-min-max-items-optional", utils_1.assertValidSchema("array-min-max-items-optional", "MyType"));
    it("array-max-items-optional", utils_1.assertValidSchema("array-max-items-optional", "MyType"));
    it("shorthand-array", utils_1.assertValidSchema("shorthand-array", "MyType"));
});
